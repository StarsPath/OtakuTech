...
namespace OtakuTech.Content.Items.Weapons.FiveStars
{
    public class KeyOfVoid : ModItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, vector50, v5, ModContent.ProjectileType<Projectiles.CommandmentsProjectile>(), (int)(damage *((float)Item.useTime/ Item.useAnimation)), knockback, player.whoAmI);
            return false;
