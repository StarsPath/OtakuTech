...
{
    public class HekatesCross : ModProjectile
    {
        private bool captureDir = false;
        private float shootcd = 15;
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] > 0)
            {
                ...
                if(Projectile.ai[0] >= shootcd)
                {
                    ...
                    int proj = Projectile.NewProjectile(new EntitySource_Misc("Hekates Cross"), Projectile.Center.X + Main.rand.NextFloatDirection() * 200f, Projectile.Center.Y - 1000, 0, shootSpeed, ModContent.ProjectileType<FangsOfDusk>(), Projectile.damage, Projectile.knockBack, Main.myPlayer, 0f, 0f);
