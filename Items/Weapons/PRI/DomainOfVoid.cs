    ...
    public class DomainOfVoid : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                {
                    Projectile.NewProjectile(player.Center, default, ModContent.ProjectileType<Projectiles.BlackHole>(), item.damage / 10, 0f, Main.myPlayer);
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            if (modplayer.comboCount >= 3)
            {
                ...
                Projectile.NewProjectile(Main.MouseWorld, default, ModContent.ProjectileType<Projectiles.BlackHole>(), item.damage / 10, 0f, Main.myPlayer);
                for (int i = 0; i < 3; i++)
                {
                    ...
                    int proj = Projectile.NewProjectile(Main.MouseWorld + randPos, vel, ModContent.ProjectileType<Projectiles.CommandmentsProjectile>(), damage, knockBack, Main.myPlayer);
