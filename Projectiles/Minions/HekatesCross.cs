        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] > 0)
            {
                ...
                if(projectile.ai[0] >= shootcd)
                {
                    ...
                    int proj = Projectile.NewProjectile(projectile.Center.X + Main.rand.NextFloatDirection() * 200f, projectile.Center.Y - 1000, 0, shootSpeed, ModContent.ProjectileType<FangsOfDusk>(), projectile.damage, projectile.knockBack, Main.myPlayer, 0f, 0f);
